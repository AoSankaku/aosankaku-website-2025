...
当サイトでは、ブログ記事の更新時にRSSも更新しています。

https://aosankaku.net/rss.xml

`https://aosankaku.net/rss`と`https://aosankaku.net/rss/`は、上と同じURLにリダイレクトします。
...
> [!TIP] 怖がらずにフォローしてね
> ほとんどの項目は、このページを読んでくれるような人なら当てはまらないと思います。

> [!NOTE] 元々知り合いの人へ
> 以下の基準は、知り合いには原則適用しません。99％フォロバしています。来ない場合は単に忘れているので、急かしてください。ほとんど使っていないところではフォロバが1年以上遅れるかもしれません。

以下に一つでも当てはまる人はフォローを __返さない__ ことがあります。当てはまらない場合にフォローを返すことを確約するものではありません。

* 宣伝が多いアカウント（自作ゲーム・作品等を除く）
* 趣味趣向が全く合致しない人、私の地雷を踏む投稿が多い人
* 主張・攻撃が多い人
* アカウント作成から3日が経過していない人（ただしTwitterやMisskey.ioのようなLTLが存在しない、または機能していないサーバーまたはリモートフォローの場合に限る）
* 活動のない人、具体的に：
  1. 手入力の投稿が週に8回以下程度の人
  2. 手入力の投稿数が合計25件以下の人
  3. リアクションやいいねの件数が週に20回以下の人
* フォロー数がフォロワー数より多く、かつフォロバ目的ともとれる人
  1. Twitter（旧X）などの場合は1.4倍を目安
  2. Fediverse上、特に小規模サーバーの場合は2倍を目安
...
[ホーム](/)の連絡先アイコンのどれかからリプ・DMなどを重要度に応じて適当に送ってください。見たり見なかったりします。最近の投稿がある方が反応が早いです。

### 著作権（侵害の通知、利用許可申請）

本人性の確認を強固にするために、大変お手数ですが以下のいずれかの方法でご連絡ください。

#### Keybaseによる方法

会員登録またはログイン後、必ず権利侵害を受けたドメイン・アカウントの情報連携などをしていただいたうえでご連絡ください。

https://keybase.io/ao_sankaku

#### メールによる連絡

当サイトは営利サイトではないため、スパム防止の観点からメールアドレスの掲載をしておりません。メールによるご連絡をご希望の場合は、[ホーム](/)の連絡先アイコンのどれかにメッセージをお送りいただき、その後にSPF、DKIM、DMARCを適切に設定した独自ドメインからお送りください。

#### Keybaseも独自ドメインもお持ちではない場合

その他、信頼に足る方法（実在する弁護士事務所等を通じて連絡を入れるなど）でご連絡ください。信頼に足る方法を取っていない場合、なりすましとみなし連絡を拒絶することがあります。